        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaloriasConsumidas = table.Column<double>(type: "double", nullable: false),
                    CaloriasQuemadas = table.Column<double>(type: "double", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EdadMinRecom = table.Column<int>(type: "int", nullable: false),
                    EdadMaxRecom = table.Column<int>(type: "int", nullable: false),
                    PesoMaxRecom = table.Column<int>(type: "int", nullable: false),
                    PesoMinRecom = table.Column<int>(type: "int", nullable: false),
                    AlturaMinRecom = table.Column<int>(type: "int", nullable: false),
                    AlturaMaxRecom = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Proteinas = table.Column<float>(type: "float", nullable: false),
                    Carbohidratos = table.Column<float>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPlanesEntrenamientos", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRecetas", x => x.Id);
                    table.ForeignKey(
